      ...
      {props.store.games[0]
        ...
        <TableContainer component={Paper} className={classes.tableContainer}>
          <Table className={classes.table} aria-label="simple table">
            <TableHead>
              <TableRow>
                <TableCell style={{color: 'white'}} align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Jeu</TableCell>
                <TableCell style={{color: 'white'}} align="left">Temps</TableCell>
                <TableCell style={{color: 'white'}} align="right">Diffuser</TableCell>
