  ...
  return (
    <div className={classes.shadow}>
      <BottomNavigation position="fixed" value={value} onChange={handleChange} className={classes.navBar}>
        <BottomNavigationAction label="Acceuil" style={{ color: iconColor.boardColor }} onClick={() => { props.history.push('/the-board') }} value={'boardColor'} icon={<DashboardIcon fontSize="large" style={{ fill: iconColor.boardColor }} />} />
